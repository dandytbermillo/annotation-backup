...
const PROVENANCE_STYLES: Record<ChatProvenance, { emoji: string; label: string; className: string }> = {
  ...
  deterministic_surface: { emoji: '\u2705', label: 'Deterministic-Surface', className: 'bg-gray-800 text-white border-gray-400/40' },
  llm_executed: { emoji: '\uD83E\uDDE0', label: 'Auto-Executed', className: 'bg-blue-900/50 text-blue-300 border-blue-600/30' },
  bounded_clarification: { emoji: '\uD83C\uDFAF', label: 'Bounded-Selection', className: 'bg-green-900/50 text-green-300 border-green-600/30' },
