 ...
 * - Hover effects
 */
export function WidgetStudioConnections({ canvasItems }: WidgetStudioConnectionsProps) {
  ...
  panels.forEach((panel) => {
    ...
    const parentPos = parentBranch?.position ?? parentPanel.position
    const childPos = branch?.position ?? panel.position
