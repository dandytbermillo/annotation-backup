-- Migration 053: Remove links_note_tiptap panel type (rollback)
-- Part of Quick Links TipTap Version feature
-- Purpose: Revert links_note_tiptap panel type

BEGIN;

-- Remove any links_note_tiptap panels first
DELETE FROM workspace_panels WHERE panel_type = 'links_note_tiptap';

-- Drop updated constraint
ALTER TABLE workspace_panels DROP CONSTRAINT IF EXISTS workspace_panels_panel_type_check;

-- Restore previous constraint without links_note_tiptap type
