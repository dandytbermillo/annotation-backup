...
import type { ChatMessage, SelectionOption, LastClarificationState, WorkspaceMatch, NoteMatch } from '@/lib/chat'
import type { ClarificationOption, ClarificationSnapshot, PanelDrawerData, DocData, SelectionContinuityState } from '@/lib/chat/chat-navigation-context'
...
import { isExplicitCommand, isSelectionOnly, resolveScopeCue, canonicalizeCommandInput, classifyArbitrationConfidence, isStrictExactMatch, evaluateDeterministicDecision, isVerifyOpenQuestion, findPoliteWrapperExactMatch, isStrictExactMode } from '@/lib/chat/input-classifiers'
...
// =============================================================================
// Barrel Re-exports (PR1 extracted modules)
// =============================================================================
