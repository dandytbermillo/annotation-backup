...
export type ChatProvenance = 'deterministic' | 'llm_executed' | 'llm_influenced' | 'llm_clarifier' | 'safe_clarifier' | 'memory_exact' | 'memory_semantic' | 's6_enforced' | 'content_answered'
