...
export type ChatProvenance = 'deterministic' | 'deterministic_surface' | 'llm_executed' | 'bounded_clarification' | 'llm_influenced' | 'llm_clarifier' | 'safe_clarifier' | 'memory_exact' | 'memory_semantic' | 's6_enforced' | 'content_answered'
