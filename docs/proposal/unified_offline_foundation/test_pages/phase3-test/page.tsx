    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="mt-4">
            <h3 className="text-lg font-semibold mb-2">Resolution Actions:</h3>
            <ul className="list-disc list-inside space-y-1 text-sm">
              <li><strong>Keep Mine:</strong> Use your version, discard server changes</li>
              <li><strong>Use Latest:</strong> Accept server version, discard your changes</li>
              <li><strong>Merge:</strong> Attempt automatic three-way merge</li>
              <li><strong>Force Save:</strong> Override server version (requires confirmation)</li>
            </ul>
          </div>
        </div>
